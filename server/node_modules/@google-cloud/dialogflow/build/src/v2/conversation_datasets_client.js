...
exports.ConversationDatasetsClient = void 0;
 ...
 */
const gapicConfig = require("./conversation_datasets_client_config.json");
...
class ConversationDatasetsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listConversationDatasets: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'conversationDatasets'),
        };
        ...
        const createConversationDatasetResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.ConversationDataset');
        const createConversationDatasetMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.CreateConversationDatasetOperationMetadata');
        const deleteConversationDatasetResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteConversationDatasetMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.DeleteConversationDatasetOperationMetadata');
        const importConversationDataResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.ImportConversationDataOperationResponse');
        const importConversationDataMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.ImportConversationDataOperationMetadata');
        this.descriptors.longrunning = {
            createConversationDataset: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createConversationDatasetResponse.decode.bind(createConversationDatasetResponse), createConversationDatasetMetadata.decode.bind(createConversationDatasetMetadata)),
            deleteConversationDataset: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteConversationDatasetResponse.decode.bind(deleteConversationDatasetResponse), deleteConversationDatasetMetadata.decode.bind(deleteConversationDatasetMetadata)),
            importConversationData: new this._gaxModule.LongrunningDescriptor(this.operationsClient, importConversationDataResponse.decode.bind(importConversationDataResponse), importConversationDataMetadata.decode.bind(importConversationDataMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.v2.ConversationDatasets', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.conversationDatasetsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.v2.ConversationDatasets')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.v2.ConversationDatasets, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of conversationDatasetsStubMethods) {
            const callPromise = this.conversationDatasetsStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getConversationDataset(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    createConversationDataset(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkCreateConversationDatasetProgress(name) {
    ...
    deleteConversationDataset(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkDeleteConversationDatasetProgress(name) {
    ...
    importConversationData(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkImportConversationDataProgress(name) {
    ...
    listConversationDatasets(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   for more details and examples.
     */
    listConversationDatasetsStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.listConversationDatasets.createStream(this.innerApiCalls.listConversationDatasets, request, callSettings);
    }
    /**
     ...
     */
    listConversationDatasetsAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.listConversationDatasets.asyncIterate(this.innerApiCalls['listConversationDatasets'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=conversation_datasets_client.js.map