 ...
 * @memberof v2
 */
export declare class ConversationModelsClient {
    private _terminated;
    private _opts;
     ...
     */
    undeployConversationModel(request?: protos.google.cloud.dialogflow.v2.IUndeployConversationModelRequest, options?: CallOptions): Promise<[
