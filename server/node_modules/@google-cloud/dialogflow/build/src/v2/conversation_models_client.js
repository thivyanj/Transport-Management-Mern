...
exports.ConversationModelsClient = void 0;
 ...
 */
const gapicConfig = require("./conversation_models_client_config.json");
...
class ConversationModelsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listConversationModels: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'conversationModels'),
            listConversationModelEvaluations: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'conversationModelEvaluations'),
        };
        ...
        const createConversationModelResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.ConversationModel');
        const createConversationModelMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.CreateConversationModelOperationMetadata');
        const deleteConversationModelResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteConversationModelMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.DeleteConversationModelOperationMetadata');
        const deployConversationModelResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deployConversationModelMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.DeployConversationModelOperationMetadata');
        const undeployConversationModelResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const undeployConversationModelMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.UndeployConversationModelOperationMetadata');
        const createConversationModelEvaluationResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.ConversationModelEvaluation');
        const createConversationModelEvaluationMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.CreateConversationModelEvaluationOperationMetadata');
        this.descriptors.longrunning = {
            createConversationModel: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createConversationModelResponse.decode.bind(createConversationModelResponse), createConversationModelMetadata.decode.bind(createConversationModelMetadata)),
            deleteConversationModel: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteConversationModelResponse.decode.bind(deleteConversationModelResponse), deleteConversationModelMetadata.decode.bind(deleteConversationModelMetadata)),
            deployConversationModel: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deployConversationModelResponse.decode.bind(deployConversationModelResponse), deployConversationModelMetadata.decode.bind(deployConversationModelMetadata)),
            undeployConversationModel: new this._gaxModule.LongrunningDescriptor(this.operationsClient, undeployConversationModelResponse.decode.bind(undeployConversationModelResponse), undeployConversationModelMetadata.decode.bind(undeployConversationModelMetadata)),
            createConversationModelEvaluation: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createConversationModelEvaluationResponse.decode.bind(createConversationModelEvaluationResponse), createConversationModelEvaluationMetadata.decode.bind(createConversationModelEvaluationMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.v2.ConversationModels', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.conversationModelsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.v2.ConversationModels')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.v2.ConversationModels, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of conversationModelsStubMethods) {
            const callPromise = this.conversationModelsStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getConversationModel(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    getConversationModelEvaluation(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    createConversationModel(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkCreateConversationModelProgress(name) {
    ...
    deleteConversationModel(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkDeleteConversationModelProgress(name) {
    ...
    deployConversationModel(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkDeployConversationModelProgress(name) {
    ...
    undeployConversationModel(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkUndeployConversationModelProgress(name) {
    ...
    createConversationModelEvaluation(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkCreateConversationModelEvaluationProgress(name) {
    ...
    listConversationModels(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listConversationModelsStream(request, options) {
        ...
        return this.descriptors.page.listConversationModels.createStream(this.innerApiCalls.listConversationModels, request, callSettings);
    }
    /**
    ...
    listConversationModelsAsync(request, options) {
        ...
        return this.descriptors.page.listConversationModels.asyncIterate(this.innerApiCalls['listConversationModels'], request, callSettings);
    }
    listConversationModelEvaluations(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listConversationModelEvaluationsStream(request, options) {
        ...
        return this.descriptors.page.listConversationModelEvaluations.createStream(this.innerApiCalls.listConversationModelEvaluations, request, callSettings);
    }
    /**
    ...
    listConversationModelEvaluationsAsync(request, options) {
        ...
        return this.descriptors.page.listConversationModelEvaluations.asyncIterate(this.innerApiCalls['listConversationModelEvaluations'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=conversation_models_client.js.map