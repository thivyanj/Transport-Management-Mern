...
class ConversationProfilesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const setSuggestionFeatureConfigResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.ConversationProfile');
        const setSuggestionFeatureConfigMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.SetSuggestionFeatureConfigOperationMetadata');
        const clearSuggestionFeatureConfigResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.ConversationProfile');
        const clearSuggestionFeatureConfigMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.ClearSuggestionFeatureConfigOperationMetadata');
