...
class DocumentsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const importDocumentsResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.ImportDocumentsResponse');
        const importDocumentsMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.KnowledgeOperationMetadata');
        ...
        const exportDocumentResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.Document');
        const exportDocumentMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.KnowledgeOperationMetadata');
        this.descriptors.longrunning = {
            ...
            exportDocument: new this._gaxModule.LongrunningDescriptor(this.operationsClient, exportDocumentResponse.decode.bind(exportDocumentResponse), exportDocumentMetadata.decode.bind(exportDocumentMetadata)),
        };
    ...
    exportDocument(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkExportDocumentProgress(name) {
