...
export declare class EncryptionSpecServiceClient {
     ...
     */
    getEncryptionSpec(request?: protos.google.cloud.dialogflow.v2.IGetEncryptionSpecRequest, options?: CallOptions): Promise<[
        protos.google.cloud.dialogflow.v2.IEncryptionSpec,
        protos.google.cloud.dialogflow.v2.IGetEncryptionSpecRequest | undefined,
        {} | undefined
    ]>;
    getEncryptionSpec(request: protos.google.cloud.dialogflow.v2.IGetEncryptionSpecRequest, options: CallOptions, callback: Callback<protos.google.cloud.dialogflow.v2.IEncryptionSpec, protos.google.cloud.dialogflow.v2.IGetEncryptionSpecRequest | null | undefined, {} | null | undefined>): void;
    getEncryptionSpec(request: protos.google.cloud.dialogflow.v2.IGetEncryptionSpecRequest, callback: Callback<protos.google.cloud.dialogflow.v2.IEncryptionSpec, protos.google.cloud.dialogflow.v2.IGetEncryptionSpecRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     */
    initializeEncryptionSpec(request?: protos.google.cloud.dialogflow.v2.IInitializeEncryptionSpecRequest, options?: CallOptions): Promise<[
    ...
    initializeEncryptionSpec(request: protos.google.cloud.dialogflow.v2.IInitializeEncryptionSpecRequest, options: CallOptions, callback: Callback<LROperation<protos.google.cloud.dialogflow.v2.IInitializeEncryptionSpecResponse, protos.google.cloud.dialogflow.v2.IInitializeEncryptionSpecMetadata>, protos.google.longrunning.IOperation | null | undefined, {} | null | undefined>): void;
    initializeEncryptionSpec(request: protos.google.cloud.dialogflow.v2.IInitializeEncryptionSpecRequest, callback: Callback<LROperation<protos.google.cloud.dialogflow.v2.IInitializeEncryptionSpecResponse, protos.google.cloud.dialogflow.v2.IInitializeEncryptionSpecMetadata>, protos.google.longrunning.IOperation | null | undefined, {} | null | undefined>): void;
    /**
     ...
     * region_tag:dialogflow_v2_generated_EncryptionSpecService_InitializeEncryptionSpec_async
     */
    checkInitializeEncryptionSpecProgress(name: string): Promise<LROperation<protos.google.cloud.dialogflow.v2.InitializeEncryptionSpecResponse, protos.google.cloud.dialogflow.v2.InitializeEncryptionSpecMetadata>>;
    /**
