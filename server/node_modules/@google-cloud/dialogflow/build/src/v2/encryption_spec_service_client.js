...
class EncryptionSpecServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const initializeEncryptionSpecResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.InitializeEncryptionSpecResponse');
        const initializeEncryptionSpecMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.InitializeEncryptionSpecMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.v2.EncryptionSpecService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.encryptionSpecServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.v2.EncryptionSpecService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.v2
                    .EncryptionSpecService, this._opts, this._providedCustomServicePath);
